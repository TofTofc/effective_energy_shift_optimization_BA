...
def submethod_analysis(version_name, worst_case_scenario=False, new_worst_case_scenario=False, phase_count=100000):

    module = import_version(version_name)

    energy_excess_lists, energy_deficit_lists, start_time_phases = init(worst_case_scenario, new_worst_case_scenario, 125, phase_count, 1)

    energy_excess_lists_fake, energy_deficit_lists_fake, start_time_phases_fake = init(worst_case_scenario, new_worst_case_scenario, 125, 10, 1)
...
def test_versions(versions_to_test, start=10, end=1000, repetitions_count=1, worst_case_scenario=False, new_worst_case_scenario=False):
    ...
    for i in range(start, end):
        ...
        energy_excess_lists, energy_deficit_lists, start_time_phases = init(
            worst_case_scenario, new_worst_case_scenario, 125, i, repetitions_count
        )
...
def test_version_solo(version_name, worst_case_scenario=False, new_worst_case_scenario=False, phase_count=5):
...
def visualize_output_each_step(phase_count, version_name="x_new_version_fusion_output_each_step", worst_case_scenario=False, new_worst_case_scenario=False):
