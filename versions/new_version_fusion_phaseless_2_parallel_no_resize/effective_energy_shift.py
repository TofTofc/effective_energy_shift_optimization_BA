...
@njit(nogil = True, inline = "always", boundscheck = 1, fastmath = True)
...
@njit(parallel = True, nogil = True, inline = "always", boundscheck = 1, fastmath = True)
...
@njit(nogil = True, parallel = True, boundscheck  = 1, fastmath = True)
